  ...
  try {
    await pool.query(`
      ...
      INSERT INTO cms_content (key, value) VALUES
        ...
        ('policy_2_desc',       'ग्राहक को प्रोजेक्ट से संबंधित RERA, Approved Plan, Title Documents और आवश्यक Approvals की जानकारी/दस्तावेज उपलब्ध कराए जाएँ, जहाँ लागू हों।'),
        ...
        ('policy_5_desc',       'Booking से लेकर possession तक एक Dedicated Customer Support System हो—site updates, documentation, payment status, complaints और after-sales service के लिए स्पष्ट संपर्क व्यवस्था।'),
        ...
        ('feature_3_title',     'Cascading PMI Family Bonus'),
        ('feature_3_desc',      'Unlock premium rewards and trigger automated 20% cascading PMI family bonuses as your property downline expands.'),
...
router.put('/content', cmsAuth, async (req, res) => {
  ...
  try {
    const allowedKeys = [
      ...
      'policies_title','policies_subtitle',
      'policy_1_title','policy_1_desc',
      'policy_2_title','policy_2_desc',
      'policy_3_title','policy_3_desc',
      'policy_4_title','policy_4_desc',
      'policy_5_title','policy_5_desc',
